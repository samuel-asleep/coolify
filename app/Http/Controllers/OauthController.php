    ...
    public function callback(string $provider)
    {
        try {
            ...
            if (! $user) {
                ...
                // If the user exists but doesn't have an OAuth provider set, update it
                // This handles the case where a user was created with password but now logs in via OAuth

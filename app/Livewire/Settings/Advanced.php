...
class Advanced extends Component
{
    ...
    #[Validate('boolean')]
    public bool $enforce_oauth_only;
    ...
    public function mount()
    {
        ...
        $this->enforce_oauth_only = $this->settings->enforce_oauth_only;
    ...
    public function instantSave()
    {
        try {
            ...
            $this->settings->enforce_oauth_only = $this->enforce_oauth_only;
